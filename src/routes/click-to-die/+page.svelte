...
<div class="flex justify-center items-center h-screen">
	...
	<a href="https://duckduckgo.com/?t=ffab&q=suicide+hotline&ia=answer" class="z-50">
		<button class="px-4 py-2 bg-gray-500 text-white rounded hover:bg-gray-600 focus:outline-none">
			Click to Die
		</button>
	</a>
